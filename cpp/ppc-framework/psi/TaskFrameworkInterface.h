 ...
 *
 * @brief the PSIFrameworkInterface
 * @file PSIFrameworkInterface.h
 * @author: yujiechen
 * @date 2022-11-16
 */
#pragma once
...
class PSIFrameworkInterface
{
public:
    using Ptr = std::shared_ptr<PSIFrameworkInterface>;
    PSIFrameworkInterface() = default;
    virtual ~PSIFrameworkInterface() = default;
